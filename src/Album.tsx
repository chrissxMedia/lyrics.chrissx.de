...
const contains = (a?: string, b?: string): boolean | undefined | "" => a && b && a.toLowerCase().includes(b.toLowerCase());

function matched(t: track, search: string, invert: boolean): boolean | undefined | "" {
...
export default function Album(props: album & { search: string, invert: boolean, musixmatch: boolean, hide: boolean }) {
